    ...
    <div class="row row-gap-3">
        <div class="col-lg-4 col-md-12">
            <div class="p-3 bg-body-tertiary rounded shadow-sm">
                ...
                <!-- Add gear modal -->
                <GearsAddEditUserModalComponent :action="'add'" @createdGear="addGearList"
                ...
                <form>
                    <div class="mb-3">
                        <input class="form-control" type="text" name="gearNickname"
                            :placeholder='$t("gearsView.placeholderSearchGearByNickname")' v-model="searchNickname"
                            required>
                    </div>
                </form>
            </div>
        ...
        <div class="col">
            ...
            <div v-else>
                ...
                <div v-if="userGears && userGears.length" class="p-3 bg-body-tertiary rounded shadow-sm">
                    ...
                    <span class="mb-1">{{ $t("gearsView.displayUserNumberOfGears1") }}{{ userGearsNumber }}{{
                    ...
                    <PaginationComponent :totalPages="totalPages" :pageNumber="pageNumber"
                        @pageNumberChanged="setPageNumber" v-if="!searchNickname" />
                </div>

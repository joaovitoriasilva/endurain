<template>
	...
	<div class="p-3 mb-3 bg-body-tertiary border-0 rounded">
		<div class="row align-items-end">
			...
			<!-- Name Search -->
			<div class="col-md-3">
				<label for="nameSearchFilter" class="form-label">{{ $t('activitiesView.filterLabelNameLocation')
				}}</label>
			...
			<div class="col-12 mt-3 d-flex justify-content-end gap-3">
				<button type="button" class="btn btn-secondary" @click="clearFilters">{{
					$t('activitiesView.buttonClear') }}</button>
	...
	<div class="p-3 bg-body-tertiary rounded shadow-sm" v-else-if="activities && activities.length">
		<!-- Activities Table -->
		<ActivitiesTableComponent :activities="activities" :sort-by="sortBy" :sort-order="sortOrder"
			@sortChanged="handleSort" v-if="activities && activities.length" />

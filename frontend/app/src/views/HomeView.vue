  ...
  <div class="row">
          ...
          <div class="modal-content">
            ...
            <form @submit.prevent="submitUploadFileForm">
              <div class="modal-body">
                <!-- date fields -->
                <label for="activityGpxFileAdd"
                  ><b>* {{ $t('homeView.fieldLabelUploadGPXFile') }}</b></label
                >
                <input
                  class="form-control mt-1 mb-1"
                  type="file"
                  name="activityGpxFileAdd"
                  accept=".gpx,.fit"
                  required
                />
    ...
    <div class="col">
      ...
      <div id="userActivitiesDiv" v-show="selectedActivityView === 'userActivities'">
        ...
        <div v-else>
          ...
          <div v-if="userActivities && userActivities.length">
            ...
            <div
              class="card mb-3 bg-body-tertiary border-0 shadow-sm"
      ...
      <div id="followersActivitiesDiv" v-show="selectedActivityView === 'followersActivities'">
        ...
        <div v-else>
          <div v-if="followedUserActivities && followedUserActivities.length"></div>
          <NoItemsFoundComponent v-else />
        </div>
      </div>
    </div>

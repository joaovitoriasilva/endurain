  ...
  setup() {
    ...
    async function fetchMoreActivities() {
      ...
      try {
        ...
        (authStore.user.id, pageNumberUserActivities.value, numRecords);
    ...
    onMounted(async () => {
      ...
      try {
        ...
        // Fetch the user activities and user activities number
        userNumberOfActivities.value = await activities.getUserNumberOfActivities(authStore.user.id);
        userActivities.value = await activities.getUserActivitiesWithPagination(authStore.user.id, pageNumberUserActivities.value, numRecords);

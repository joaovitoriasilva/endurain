  ...
  <div class="bg-body-tertiary shadow-sm rounded p-3">
    <div class="row justify-content-center align-items-center">
      <div class="col d-none d-lg-block">
        <img width="auto" height="auto" :src="loginPhotoUrl" alt="Square signup image" class="img-fluid rounded"
          v-if="serverSettingsStore.serverSettings.login_photo_set" />
        <img width="auto" height="auto" src="/src/assets/login.png" alt="Square signup image" class="img-fluid rounded"
          v-else />
      </div>
      <div class="col form-signin m-3">
        <form @submit.prevent="submitForm">
          ...
          <div class="form-floating mb-3">
            <input type="text" class="form-control" id="name" :placeholder="$t('signupView.name')" v-model="signUpName"
              required />
          ...
          <!-- Username field -->
          <div class="form-floating mb-3">
            <input type="text" class="form-control" id="username" :placeholder="$t('signupView.username')"
              v-model="signUpUsername" required />
            <label for="username">* {{ $t('signupView.username') }}</label>
          </div>

          <!-- Email field -->
          <div class="form-floating mb-3">
            <input type="email" class="form-control" id="validationEmail" aria-describedby="validationEmailFeedback"
              :class="{ 'is-invalid': !isEmailValid }" :placeholder="$t('signupView.email')" v-model="signUpEmail"
              required />
          ...
          <div class="form-floating mb-3 position-relative">
            <input :type="showPassword ? 'text' : 'password'" class="form-control"
              ...
              aria-describedby="validationPasswordFeedback" name="signUpPassword"
              :placeholder="$t('signupView.password')" v-model="signUpPassword" required />
          ...
          <div v-if="showOptionalFields">
            ...
            <div class="form-floating mb-3">
              ...
              <label for="preferredLanguage">
                {{
                  $t('signupView.preferredLanguage')
                }}</label>
            </div>
            <!-- City field -->
            <div class="form-floating mb-3">
              <input type="text" class="form-control" id="city" :placeholder="$t('signupView.city')"
                v-model="signUpCity" />
            ...
            <!-- Birth date field -->
            <div class="form-floating mb-3">
              <input type="date" class="form-control" id="birthdate" :placeholder="$t('signupView.birthdate')"
            ...
            <div class="input-group mb-3" v-else>
              <div class="form-floating flex-grow-1">
                <input class="form-control" :class="{ 'is-invalid': !isFeetValid }" type="number"
                  aria-describedby="validationFeetFeedback" name="signUpHeightFeet" :placeholder="$t('signupView.height')
                    " v-model="signUpHeightFeet" min="0" max="10" step="1" />
              ...
              <div class="form-floating flex-grow-1">
                <input class="form-control" :class="{ 'is-invalid': !isInchesValid }" type="number"
                  aria-describedby="validationInchesFeedback" name="signUpHeightInches" :placeholder="$t('signupView.height')
                    " v-model="signUpHeightInches" min="0" max="11" step="1" />
            ...
            <div class="form-floating mb-3">
              <select class="form-select" name="firstDayOfWeek" v-model="signUpFirstDayOfWeek" required>
...
const submitForm = async () => {
  if (Number(serverSettingsStore.serverSettings.units) === 1) {
    ...
    signUpHeightCms.value = feetAndInchesToCm(
      signUpHeightFeet.value,
      signUpHeightInches.value
    )
  }
  try {

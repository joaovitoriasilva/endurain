	...
	<div class="col">
		<div class="bg-body-tertiary rounded p-3 shadow-sm">
			<div class="row row-gap-3">
					...
					<div class="row mt-3">
						<div class="col">
							...
							<a class="w-100 btn btn-danger" href="#" role="button" data-bs-toggle="modal"
								...
								v-if="authStore.user.photo_path"><font-awesome-icon :icon="['fas', 'image']"
									class="me-1" />{{
						...
						<div class="col">
							...
							<a class="w-100 btn btn-primary" href="#" role="button" data-bs-toggle="modal"
								data-bs-target="#editProfileModal"><font-awesome-icon :icon="['fas', 'user-pen']"
									class="me-1" />{{
				...
				<div class="col">
					...
					<p>
						...
						<font-awesome-icon :icon="['fas', 'venus']" class="me-2"
					...
					<p>
						...
						<span v-if="authStore.user.height">
							<span v-if="Number(authStore?.user?.units) === 1">{{ authStore.user.height }}{{
				...
				<div class="row" v-else>
					<div class="col-lg-4 col-md-12">
						...
						<form>
							...
							<select class="form-select" name="settingsUserProfileRunGearSelect" v-model="defaultRunGear"
								required>
								<option :value="null">
							...
							<select class="form-select" name="settingsUserProfileTrailRunGearSelect"
								v-model="defaultTrailRunGear" required>
								<option :value="null">
									{{ $t('settingsUserProfileZone.selectOptionNotDefined') }}
								</option>
								<option v-for="gear in runGear" :key="gear.id" :value="gear.id">
							...
							<select class="form-select" name="settingsUserProfileVirtualRunGearSelect"
								v-model="defaultVirtualRunGear" required>
								<option :value="null">
									{{ $t('settingsUserProfileZone.selectOptionNotDefined') }}
								</option>
								<option v-for="gear in runGear" :key="gear.id" :value="gear.id">
							...
							<select class="form-select" name="settingsUserProfileWalkGearSelect"
								v-model="defaultWalkGear" required>
								<option :value="null">
									{{ $t('settingsUserProfileZone.selectOptionNotDefined') }}
								</option>
								<option v-for="gear in runGear" :key="gear.id" :value="gear.id">
							...
							<select class="form-select" name="settingsUserProfileHikeGearSelect"
								v-model="defaultHikeGear" required>
								<option :value="null">
									{{ $t('settingsUserProfileZone.selectOptionNotDefined') }}
								</option>
								<option v-for="gear in runGear" :key="gear.id" :value="gear.id">
					...
					<div class="col-lg-4 col-md-12">
						...
						<form>
							...
							<select class="form-select" name="settingsUserProfileRideGearSelect"
								v-model="defaultRideGear" required>
								<option :value="null">
									{{ $t('settingsUserProfileZone.selectOptionNotDefined') }}
								</option>
							...
							<select class="form-select" name="settingsUserProfileMTBRideGearSelect"
								v-model="defaultMTBRideGear" required>
								<option :value="null">
									{{ $t('settingsUserProfileZone.selectOptionNotDefined') }}
								</option>
								<option v-for="gear in bikeGear" :key="gear.id" :value="gear.id">
							...
							<select class="form-select" name="settingsUserProfileGravelRideGearSelect"
								v-model="defaultGravelRideGear" required>
								<option :value="null">
									{{ $t('settingsUserProfileZone.selectOptionNotDefined') }}
								</option>
								<option v-for="gear in bikeGear" :key="gear.id" :value="gear.id">
					...
					<div class="col-lg-4 col-md-12">
						...
						<form>
							...
							<select class="form-select" name="settingsUserProfileOWSGearSelect" v-model="defaultOWSGear"
								required>
								<option :value="null">
									{{ $t('settingsUserProfileZone.selectOptionNotDefined') }}
								</option>
					...
					<div class="col-lg-4 col-md-12 mt-md-2">
						...
						<form>
							...
							<select class="form-select" name="settingsUserProfileTennisGearSelect"
								v-model="defaultTennisGear" required>
								<option :value="null">
									{{ $t('settingsUserProfileZone.selectOptionNotDefined') }}
								</option>
					...
					<div class="col-lg-4 col-md-12 mt-md-2">
						...
						<form>
							...
							<select class="form-select" name="settingsUserProfileAlpineSkiGearSelect"
								v-model="defaultAlpineSkiGear" required>
								<option :value="null">
									{{ $t('settingsUserProfileZone.selectOptionNotDefined') }}
								</option>
							...
							<select class="form-select" name="settingsUserProfileNordicSkiGearSelect"
								v-model="defaultNordicSkiGear" required>
								<option :value="null">
									{{ $t('settingsUserProfileZone.selectOptionNotDefined') }}
								</option>
								<option v-for="gear in skisGear" :key="gear.id" :value="gear.id">
							...
							<select class="form-select" name="settingsUserProfileSnowboardGearSelect"
								v-model="defaultSnowboardGear" required>
								<option :value="null">
									{{ $t('settingsUserProfileZone.selectOptionNotDefined') }}
								</option>
				...
				<div class="row mt-3">
					<div class="col">
						...
						<a class="btn btn-primary w-100" href="#" role="button" data-bs-toggle="modal"
							data-bs-target="#editUserActivitiesVisibilityModal"><font-awesome-icon
								:icon="['fas', 'eye-slash']" class="me-1" />{{
						...
						<ModalComponentSelectInput modalId="editUserActivitiesVisibilityModal"
							...
							:actionButtonType="`success`" :actionButtonText="t('settingsUserProfileZone.changeUserActivitiesVisibilityModalButton')
			...
			<ModalComponentUploadFile modalId="importDataModal" :title="$t('settingsUserProfileZone.modalImportTitle')"
				:fileFieldLabel="$t('settingsUserProfileZone.modalImportBody')" filesAccepted=".zip"
				actionButtonType="success" :actionButtonText="$t('settingsUserProfileZone.modalImportTitle')"

		...
		<div class="d-flex justify-content-between">
			...
			<div>
				...
				<div class="d-flex justify-content-end">
					<span class="badge bg-secondary-subtle border border-secondary-subtle text-secondary-emphasis me-2" v-if="user.id == authStore.user.id">{{ $t("usersListComponent.userListUserIsMeBadge") }}</span>
					<span class="badge bg-warning-subtle border border-warning-subtle text-warning-emphasis me-2" v-if="user.access_type == 2">{{ $t("usersListComponent.userListUserIsAdminBadge") }}</span>
					<span class="badge bg-success-subtle border border-success-subtle text-success-emphasis" v-if="user.is_active == 1">{{ $t("usersListComponent.userListUserIsActiveBadge") }}</span>
					<span class="badge bg-danger-subtle border border-danger-subtle text-danger-emphasis" v-else>{{ $t("usersListComponent.userListUserIsInactiveBadge") }}</span>
				</div>

                ...
                <form @submit.prevent="handleSubmit">
                    <div class="modal-body">
                        ...
                        <div>
                            <div class="row">
                                <div class="col">
                                    <input class="form-control" type="file" accept="image/*" name="userImgAddEdit" :id="action === 'edit' ? `userImgAddEdit-${user.id}` : `userImgAddEdit-${action}`" @change="handleFileChange">
                                </div>

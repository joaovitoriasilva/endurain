<template>
    <router-link class="dropdown-item link-body-emphasis text-wrap"
        ...
        <span><b>{{ $t('newActivityDuplicateStartTimeNotificationComponent.newActivityDuplicateStartTimeTitle') }}</b></span>
        <br>
        <span class="fw-lighter">
            {{ $t('newActivityDuplicateStartTimeNotificationComponent.newActivityDuplicateStartTimeSubTitle') }}
        </span>
    </router-link>
</template>

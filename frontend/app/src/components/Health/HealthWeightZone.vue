    ...
    <div class="col">
        ...
        <div v-else>
            ...
            <div v-if="dataWithWeight && dataWithWeight.length" class="mt-3 p-3 bg-body-tertiary rounded shadow-sm">
                ...
                <br>
                <p>{{ $t("healthWeightZoneComponent.labelNumberOfHealthDataWeight1") }}{{ userHealthData.length }}{{
                    $t("healthWeightZoneComponent.labelNumberOfHealthDataWeight2") }}{{ userHealthDataPagination.length
                    }}{{ $t("healthWeightZoneComponent.labelNumberOfHealthDataWeight3") }}</p>
                ...
                <!-- list zone -->
                <ul class="my-3 list-group list-group-flush" v-for="data in dataWithWeightPagination" :key="data.id"
                    :data="data">

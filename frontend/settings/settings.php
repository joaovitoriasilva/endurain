<?php
    ...
    if (isset($_POST["editProfile"])) {
        ...
        if(isset($_FILES["profileImgEdit"]) && $_FILES["profileImgEdit"]["error"] == 0){
            ...
            $editProfileAction = editUser(trim($_POST["profileNameEdit"]), trim($_POST["profileUsernameEdit"]), trim($_POST["profileEmailEdit"]), $_SESSION["id"], $_POST["profilePreferredLanguageEdit"], trim($_POST["profileCityEdit"]), $_POST["profileBirthDateEdit"], $_POST["profileGenderEdit"], $_SESSION["access_type"],$profilePhoto,$profilePhotoAux);
            setUserRelatedInfoSession($_SESSION["token"]);
        }
    }
...
<div class="container mt-4">
    ...
    <div class="row row-gap-3">
        ...
        <div class="col-lg-4 col-md-12">
            <ul class="nav nav-pills flex-column mb-auto" id="sidebarNav">
                <?php if($_SESSION["access_type"] == 2){ ?>
                    <li class="nav-item">
                        <a href="#" class="nav-link <?php if (!isset($_GET["profileSettings"]) && !isset($_GET["global"]) && !isset($_GET["gearSettings"]) && $_SESSION["access_type"] == 2){ echo "text-white active"; } ?>" onclick="changeActive(event, 'divUsers')">
                        <svg class="bi pe-none me-2" width="16" height="16"></svg>
                        <?php echo $translationsSettings['settings_sidebar_users']; ?>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link <?php if (isset($_GET["global"]) && $_SESSION["access_type"] == 2){ echo "text-white active"; } ?>" onclick="changeActive(event, 'divGlobal')">
                        <svg class="bi pe-none me-2" width="16" height="16"></svg>
                ...
                <?php } ?>
                <li class="nav-item">
                    <a href="#" class="nav-link <?php if (isset($_GET["profileSettings"]) || ($_SESSION["access_type"] == 1 && !isset($_GET["profileSettings"]) && !isset($_GET["gearSettings"]))){ echo "text-white active"; } ?>" onclick="changeActive(event, 'divProfileSettings')">
                    <svg class="bi pe-none me-2" width="16" height="16"></svg>
                    <?php echo $translationsSettings['settings_sidebar_profileSettings']; ?>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link <?php if (isset($_GET["gearSettings"])){ echo "text-white active"; } ?>" onclick="changeActive(event, 'divGearSettings')">
                    <svg class="bi pe-none me-2" width="16" height="16"></svg>
        ...
        <!-- users zone -->
        <div class="col" id="divUsers" style="display: <?php if (isset($_GET["global"]) || isset($_GET["profileSettings"]) || isset($_GET["gearSettings"])){ echo "none"; }else{ echo "block"; } ?>;">
            <!-- Error banners -->
                    ...
                    <?php foreach ($users as $user) { ?>
                        <li class="list-group-item d-flex justify-content-between">
                            <div class="d-flex align-items-center">
                                <img src=<?php if(is_null($user["photo_path"])){ if($user["gender"] == 1){ echo ("../img/avatar/male1.png"); }else{ echo ("../img/avatar/female1.png"); } }else{ echo ($user["photo_path"]); }?> alt="userPicture" class="rounded-circle" width="55" height="55">
                                <div class="ms-3">
                                    <div class="fw-bold">
                                        <?php echo ($user["username"]); ?>
                                    </div>
                                    <b><?php echo $translationsSettings['settings_sidebar_users_list_user_accesstype']; ?></b><?php if($user["access_type"] == 1){ echo $translationsSettings['settings_sidebar_users_modal_addEditUser_typeOption1']; }else{ if($user["access_type"] == 2){ echo $translationsSettings['settings_sidebar_users_modal_addEditUser_typeOption2']; }} ?>
                                </div>
                            </div>
                            <div>
                ...
                <?php if(!isset($_POST["userSearch"])){ ?>
                    ...
                    <nav>
                        <ul class="pagination justify-content-center">
                            <li class="page-item <?php if($pageNumberUsers == 1){ echo "disabled"; } ?>"><a class="page-link" href="?pageNumberUsers=1">«</a></li>
                            <?php for ($i = 1; $i <= $total_pages; $i++) { ?>
                                <li class="page-item <?php if($i == $pageNumberUsers){ echo "active"; } ?>"><a class="page-link" href="?pageNumberUsers=<?php echo ($i);?>"><?php echo ($i);?></a></li>
                            <?php } ?>
                            <li class="page-item <?php if($pageNumberUsers == $total_pages){ echo "disabled"; } ?>"><a class="page-link" href="?pageNumberUsers=<?php echo ($total_pages);?>">»</a></li>
                        </ul>
                    </nav>
                <?php } ?>
            <?php } ?>
            ...
            <div class="row row-gap-3">
                <div class="col-lg-4 col-md-12">
                    <div class="justify-content-center align-items-center d-flex">
                        <img src=<?php if(is_null($_SESSION["photo_path"])){ if($_SESSION["gender"] == 1){ echo ("../img/avatar/male1.png"); }else{ echo ("../img/avatar/female1.png"); } }else{ echo ($_SESSION["photo_path"]); }?> alt="Profile picture" width="180" height="180" class="rounded-circle">
                    </div>
                    ...
                    <?php } ?>
                    <a class="mt-2 w-100 btn <?php if($_SESSION["is_strava_linked"] == 1){ echo 'disabled'; } ?>" style="--bs-btn-bg: #FC4C02; --bs-btn-active-bg: #FC4C02; --bs-btn-hover-bg: #FC4C02; --bs-btn-disabled-bg: #FC4C02; --bs-btn-disabled-border-color: #FC4C02;" href="../settings/settings.php?profileSettings=1&linkStrava=1" <?php if($_SESSION["is_strava_linked"] == 1){ echo 'aria-disabled="true"'; } ?> role="button"><img src="../img/strava/btn_strava_connectwith_orange.png" alt="Link with strava button" width="65%" height="65%"></a>
                </div>
                ...
                <div class="col">
                    ...
                    <p><b><?php  echo $translationsSettings['settings_sidebar_profile_access_type_subtitle']; ?></b> <?php if ($_SESSION["access_type"] == 1){ echo $translationsSettings['settings_sidebar_profile_access_type_regular_user']; }else{ if ($_SESSION["access_type"] == 2){ echo $translationsSettings['settings_sidebar_profile_access_type_admin']; }else{ if ($_SESSION["access_type"] == 3){ echo $translationsSettings['settings_sidebar_profile_access_type_teacher']; }else{ echo $translationsSettings['settings_sidebar_profile_access_type_parent']; }}} ?>
                </div>
            </div>
        </div>

        <!-- gear zone -->
        <div class="col" id="divGearSettings" style="display: <?php if (isset($_GET["gearSettings"])){ echo "block"; }else{ echo "none"; } ?>;">
            <!-- Error banners -->
            ...
            <?php if($gears != NULL && $gears != -1 && $gears != -2 && $gears != -3){ ?>
                        ...
                        <li class="list-group-item d-flex justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    ...
                                    <b><?php echo $translationsSettings['settings_sidebar_settings_sidebar_gear_type']; ?></b><?php if($gear["gear_type"] == 1){ echo $translationsSettings['settings_sidebar_gear_modal_addEditGear_gearTypeOption1']; }else{ if($gear["gear_type"] == 2){ echo $translationsSettings['settings_sidebar_gear_modal_addEditGear_gearTypeOption2']; }else{ if($gear["gear_type"] == 3){ echo $translationsSettings['settings_sidebar_gear_modal_addEditGear_gearTypeOption3']; }}} ?>
                                </div>
                            </div>
                            <div>
                                <!-- gear status zone -->
                ...
                <?php if(!isset($_POST["gearSearch"])){ ?>
                    ...
                    <nav>
                        <ul class="pagination justify-content-center">
                            <li class="page-item <?php if($pageNumberGears == 1){ echo "disabled"; } ?>"><a class="page-link" href="?pageNumberGears=1">«</a></li>
                            <?php for ($i = 1; $i <= $total_pages; $i++) { ?>
                                <li class="page-item <?php if($i == $pageNumberGears){ echo "active"; } ?>"><a class="page-link" href="?pageNumberGears=<?php echo ($i);?>"><?php echo ($i);?></a></li>
                            <?php } ?>
                            <li class="page-item <?php if($pageNumberGears == $total_pages){ echo "disabled"; } ?>"><a class="page-link" href="?pageNumberGears=<?php echo ($total_pages);?>">»</a></li>
                        </ul>
                    </nav>
                <?php } ?>
            <?php } ?>

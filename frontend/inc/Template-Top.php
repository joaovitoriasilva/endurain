                ...
                <div class="navbar-nav me-auto mb-2 mb-lg-0">
                    <?php if (isLogged()) { ?>
                        <a class="nav-link <?php if (str_contains($page, "gear")) {
                                                echo ("active");
                                            } ?>" href="../gear/gears.php"><i class="fa-solid fa-bicycle"></i> <?php echo $translationsTemplateTop['template_top_navbar_gear']; ?></a>
                    <?php } ?>
                </div>
                    ...
                    <?php if (isLogged()) { ?>
                        ...
                        <a class="nav-link" href="../settings/settings.php?profileSettings=1">
                            <img src="<?php if (is_null($_SESSION["photo_path"])) {
                                        ...
                                        } ?>" alt="userPhoto" width="24" height="24" class="rounded-circle"><span class="ms-2"><?php echo $translationsTemplateTop['template_top_navbar_profile']; ?></span>
                        </a>
                        <span class="border-top d-sm-none d-block mb-2"></span>

    ...
    <div class="row row-gap-3">
        ...
        <div class="col">
            ...
            <?php } else { ?>
                ...
                <?php } else { ?>
                    <p><?php echo $translationsGearGear['gear_gear_list_title1']; ?> <?php echo ($numGears); ?> <?php echo $translationsGearGear['gear_gear_list_title2']; ?> (<?php echo $numRecords; ?> <?php echo $translationsGearGear['gear_gear_list_title3']; ?>:</p>
                            ...
                            <li class="list-group-item d-flex justify-content-between">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <b><?php echo $translationsGearGear['gear_gear_gear_type']; ?></b><?php if ($gear["gear_type"] == 1) {
                                                                                                                echo $translationsGearGear['gear_gear_modal_addEditUser_gearTypeOption1'];
                                                                                                            } else {
                                                                                                                if ($gear["gear_type"] == 2) {
                                                                                                                    echo $translationsGearGear['gear_gear_modal_addEditUser_gearTypeOption2'];
                                                                                                                } else {
                                                                                                                    if ($gear["gear_type"] == 3) {
                                                                                                                        echo $translationsGearGear['gear_gear_modal_addEditUser_gearTypeOption3'];
                                                                                                                    }
                                                                                                                }
                                                                                                            } ?>
                                        </br>

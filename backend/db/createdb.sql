...
CREATE  TABLE IF NOT EXISTS `gearguardian`.`activities` (
  `id` INT(10) NOT NULL AUTO_INCREMENT ,
  `user_id` INT(10) NOT NULL COMMENT 'User ID that the activity belongs' ,
  `name` VARCHAR(255) NULL COMMENT 'Activity name (May include spaces)' ,
  ...
  `city` VARCHAR(255) NULL COMMENT 'Activity city (May include spaces)' ,
  `town` VARCHAR(255) NULL COMMENT 'Activity town (May include spaces)' ,
  `country` VARCHAR(255) NULL COMMENT 'Activity country (May include spaces)' ,

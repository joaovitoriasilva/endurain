...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_users_default_gear_skis_gear_id"),
        "users_default_gear",
        ["skis_gear_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_users_default_gear_skis_gear_id"), table_name="users_default_gear"
    )
    op.drop_column("users_default_gear", "snowboard_gear_id")
    op.drop_column("users_default_gear", "skis_gear_id")
    op.alter_column(
        "gear",
        "gear_type",
        existing_type=sa.INTEGER(),

...
@router.get("", response_model=List[user_goals_schema.UserGoal] | None)
async def get_user_goals(
    ...
    Returns:
        List[UserGoal]: A list of user goal objects for the authenticated user.
    """
...
async def update_user_goal(
    ...
    """
    return user_goals_crud.update_user_goal(
        token_user_id, goal_id, user_goal, db
    )
